...
//      for (World.Team d : scheduleTeams){
...
//    public void scheduleTeams(World.Team t, ArrayList<World.Team> schedule){
//        //print out team schedule: debug
//
//        System.out.println("Scheduling for:" + t.name);
//        System.out.println();
//        for (World.Team a : schedule){
...
//
//        //World.Team schedule loop, go through all 17 weeks
...
//                World.Team opponent = schedule.get(opponentIndex);
...
//        }
    ...
    /**
     * Used to check if the schedule for a team is finished.    public void scheduleTeams(World.Team t){
        //print out team schedule: debug
        ...
        for (int weekNum = 0; weekNum < weekList.size(); ++weekNum){
            while (!weekFilled){
                ...
                World.Team opponent = TEAM_LIST.get(opponentIndex);
                //check if the opponent has a game on that week
...
rue;
    ...
    /**
     * This method gets the same division, same conference opponents for World.Team t.
     * e.g. World.Team t = Lions : Packers, Bears, Vikings
     * @param t
     * @return
     */
    ...
    /**
     * Used to get the teams of the division of the same conference that World.Team t will be playing
    ...
    private ArrayList<Team> populateLeague(String teamListFileName) {
        ...
        while (input.hasNextLine()) {
            ...
            Team teamToAdd = new Team(teamId, city, team, conference, division, lastDivisionFinish);
