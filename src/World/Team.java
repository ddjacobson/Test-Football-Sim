...
public class Team {
    ...
    public void reorderDepthChart() {
        Collections.sort(this.qbs, new ComparePlayerOvr());
        Collections.sort(this.rbs, new ComparePlayerOvr());
        Collections.sort(this.wrs, new ComparePlayerOvr());
        Collections.sort(this.tes, new ComparePlayerOvr());
        Collections.sort(this.tackles, new ComparePlayerOvr());
        Collections.sort(this.guards, new ComparePlayerOvr());
        Collections.sort(this.centers, new ComparePlayerOvr());
        Collections.sort(this.dEnds, new ComparePlayerOvr());
        Collections.sort(this.dTackles, new ComparePlayerOvr());
        Collections.sort(this.olbs, new ComparePlayerOvr());
        Collections.sort(this.ilbs, new ComparePlayerOvr());
        Collections.sort(this.cbs, new ComparePlayerOvr());
        Collections.sort(this.fs, new ComparePlayerOvr());
        Collections.sort(this.ss, new ComparePlayerOvr());
    }

    public boolean checkRoster() {
        return !this.hasEnoughPlayers() ? false : false;
    }

    public boolean hasEnoughPlayers() {
        return this.roster.size() == 53;
    }


    public void getScheduleTeams() {
        ArrayList<Team> conferenceTeams = this.getConferenceTeams();
        ArrayList<Team> copy = (ArrayList)conferenceTeams.clone();
        conferenceTeams.add((Team)copy.get(0));
        conferenceTeams.add((Team)copy.get(1));
        conferenceTeams.add((Team)copy.get(2));
        int finish = this.lastDivisionFinish;
        Iterator var4 = conferenceTeams.iterator();
